...
import Branham from "../assets/branham.jpg";
        ...
        <Row className="g-3">
          ...
          <Col md={6}>
            <div className="hero-box text-box">
              ...
              <p className="lead mt-4">
                ...
                We are committed to helping people grow in faith,
                build meaningful relationships, and discover God’s
                purpose for their lives.
              </p>

              <p>
                Whether you’re exploring faith, returning to church,
                or searching for a spiritual home, you belong here.
              </p>
            </div>
          </Col>
          ...
          <Col md={6}>
            <div className="hero-box text-box dark-box">
              ...
              <p className="mt-4">
                We believe God is calling His people to prepare,
                remain faithful, and walk according to His Word.
              </p>

              <p>
                Our desire is to proclaim truth, strengthen believers,
                and point every generation toward Jesus Christ.
              </p>
            </div>
          </Col>

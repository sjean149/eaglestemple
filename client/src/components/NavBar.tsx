          ...
          <Nav className="align-items-center gap-3">
            ...
            >
              ...
              >
                <NavDropdown.Item
                  href="#sermons"
                  className="d-flex align-items-start gap-3 py-2 px-3 custom-drop-item"
                  style={{ color: "#ffffff", transition: "all 0.2s" }}
                >
                  <svg
                    width="20"
                    height="20"
                  ...
                  <div>
                    ...
                    <small style={{ color: "#94a3b8", fontSize: "0.8rem" }}>
                      Watch and listen to inspired spoken Word
                    </small>
                  </div>
                </NavDropdown.Item>
                ...
                >
                  ...
                  <div>
                    ...
                    <small style={{ color: "#94a3b8", fontSize: "0.8rem" }}>
                      Stream current services in real-time
                    </small>
                  </div>
                </NavDropdown.Item>
              </div>
            ...
            <NavDropdown
              ...
              id="faith-dropdown"
              style={navLinkStyle}
              className="custom-nav-dropdown position-relative"
            >
                  ...
                  <div className="col-5 border-end border-secondary border-opacity-25 pe-3">
                    ...
                    <Link to="/about" className="mega-nav-card mt-2">
                      ...
                      <div>
                        ...
                        <div className="mega-card-desc">
                          Our mission, vision, and structural timeline
                        </div>
                      </div>
                    </Link>
                    ...
                    <a href="#leadership" className="mega-nav-card mt-3">
                      ...
                      <div>
                        ...
                        <div className="mega-card-desc">
                          Meet the pastors and advocates serving you
                        </div>
                      </div>
                    </a>
                  </div>

...
// 1. Import local image relative to src/components/
...
export default function SearchSermons() {
  ...
  const years = ["All Years", "2026", "2025", "2024", "2023", "2022", "2021", "2020", "2019", "2018", "2017"];
  ...
  return (
    <section
      ...
      style={{
        minHeight: "100vh",
        color: "#ffffff",
        /* Using the imported React asset variable eagleBg */
        backgroundImage: `linear-gradient(135deg, rgba(5, 10, 25, 0.45) 0%, rgba(13, 27, 62, 0.55) 100%), url(${eagleBg})`,
